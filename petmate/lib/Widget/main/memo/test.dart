...
class MemoList extends StatelessWidget {
  final MemosController memoController = Get.put(MemosController());
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              await memoController.deleteSelectedMemos();
            },
          ),
        ],
      ),
        ...
        builder: (context, snapshot) {
          ...
          return Obx(() => ListView(
                children: snapshot.data!.map((memo) {
                  ...
                  bool isSelected =
                      memoController.selectedMemoIds[memoId] ?? false;
                  ...
                  return ListTile(
                    leading: Checkbox(
                      ...
                      onChanged: (bool? value) {
                        ...
                        memoController.selectedMemoIds[memoId] = value ?? false;
                      },
                    ),
