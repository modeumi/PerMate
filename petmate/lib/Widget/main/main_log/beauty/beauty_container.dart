...
class BeautyContainer extends StatefulWidget {
  const BeautyContainer({super.key});

  @override
  State<BeautyContainer> createState() => _BeautyContainerState();
}

class _BeautyContainerState extends State<BeautyContainer> {
