...
class MeetCheck extends StatefulWidget {
  const MeetCheck({super.key});

  @override
  State<MeetCheck> createState() => _MeetCheckState();
}

class _MeetCheckState extends State<MeetCheck> {
  bool like = false;
  bool check = false;
